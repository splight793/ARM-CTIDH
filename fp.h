...
void fp_correction(fp* x);

void fp_add3(fp *x, fp const *y, fp const *z);
void fp_sub3(fp *x, fp const *y, fp const *z);
void fp_mul3(fp *x, fp const *y, fp const *z);
static inline void fp_add2(fp *x, fp const *y) {fp_add3(x, x, y); }
static inline void fp_sub2(fp *x, fp const *y) {fp_sub3(x, x, y); }
static inline void fp_mul2(fp *x, fp const *y) {fp_mul3(x, x, y); }
static inline void fp_sq1(fp *x) { fp_mul3(x, x, x);}                 /* squares x, updates x to result */
static inline void fp_sq2(fp *x, fp const *y){ fp_mul3(x, y, y);}    /* squares y, updates x to result */
...
void fp_double2(fp *x,const fp *y);

void fp_quadruple2(fp *x,const fp *y);
...
long long fp_iszero(fp *x);

static inline long long fp_isequal(fp *x, fp *y)
{
  fp_correction(x);
  fp_correction(y);
