...
#define _fp_0 _NAMESPACEBITS(fp_0)
#define _fp_1 _NAMESPACEBITS(fp_1)
#define _fp_2 _NAMESPACEBITS(fp_2)
#define _fp_cmov _NAMESPACEBITS(fp_cmov)
#define _fp_cswap _NAMESPACEBITS(fp_cswap)
